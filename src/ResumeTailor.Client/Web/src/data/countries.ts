export const countries = [
  ...
  { name: "Syrian Arab Republic (the)", code: "SY" },
  { name: "Taiwan (Province of China)", code: "TW" },
  { name: "Tajikistan", code: "TJ" },
  { name: "Tanzania (the United Republic of)", code: "TZ" },
  ...
  { name: "United States of the America", code: "US" },
...
export const getCountryCode = (selected: string) =>
  countries.find((country) => country.name === selected)?.code;
