...
internal sealed class SiteExtractionDefintionService(ISiteExtractionDefinitionRepository repository) : ISiteExtractionDefinitionService
{
    ...
    private static SiteExtractionDefinitionResponse MapToResponse(SiteExtractionDefinition defintion)
    {
        return new SiteExtractionDefinitionResponse(
            defintion.Id,
            defintion.SiteName,
            defintion.Hostname,
            defintion.PathPattern,
            defintion.Version,
            defintion.IsEnabled,
            defintion.Fields
